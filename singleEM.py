...
if __name__ == "__main__":
    ...
    estlab_path = 'NER_estimatedlabels/noisy' + args.noise + '_eng.train_xyc'
    ...
    c_data.save_ConLL_data(c_data.as_preds, estlab_path+'_xyc')
    c_data.save_ConLL_data(c_data.xy_uni, estlab_path[-5]+'_xc')
